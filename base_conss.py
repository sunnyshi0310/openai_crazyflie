...
class cf_consensus():
    def __init__(self):
        ...
        # CRAZYFLIE 3
            ...
            t = 1/100
            for i in range(10):
                self.cf0 = self.move_to_point(ax0,ay0,az0,ayaw0,t,i)
                self.cf1 = self.move_to_point(ax1,ay1,az1,ayaw1,t,i)
                self.cf2 = self.move_to_point(ax2,ay2,az2,ayaw2,t,i)
                self.cf3 = self.move_to_point(ax3,ay3,az3,ayaw3,t,i)
    ...
    def controller(self,n):
        ...
        u0 = 0*self.X_position[0+n*4]+1*u0
        self.U.append(u0)
        ...
        u1 = 0*self.X_position[1+n*4]+1*u1
        self.U.append(u1)
        ...
        u2 = 0*self.X_position[2+n*4]+1*u2
        self.U.append(u2)
        ...
        u3 = 0*self.X_position[3+n*4]+1*u3
        self.U.append(u3)
    ...
    def move_to_point(self,ax,ay,az,ayaw,t,i): 
        drone_msg = DroneState()
